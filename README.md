...
1. Create a new branch in [trex-release-pipeline](https://gitlab-master.nvidia.com/omniverse/trex-release-pipeline/-/pipelines) starting with `PROD-` and the same version. (i.e. `PROD-2024.2.1` for `INTEG-2024.2.1`)
