...
- Any MR: append one concise root `CHANGELOG.md` entry as the last item in the correct `## [Unreleased]` section to
  preserve chronological order; never insert at the top or reorder existing entries. Jira prefix only if provided.
