...
class UsdShadePropertyPlaceholder:
    ...
    def __init__(self, name: str, metadata: Union[dict | None], from_sdr: bool = False):
    ...
    def GetColorSpace(self) -> Union[str | None]:  # noqa: N802  # pragma: no cover
    ...
    def GetMetadata(self, key: str) -> Union[Any | None]:  # noqa: N802  # pragma: no cover
    ...
    def GetTypeName(self) -> Union[str | None]:  # noqa: N802
    ...
    def GetDefaultValue(self) -> Union[Any | None]:  # noqa: N802  # pragma: no cover
    ...
    def GetEnableIfCondition(self) -> Union[str | None]:  # noqa: N802  # pragma: no cover
    ...
    def GetSdrMetadata(self, key, default_value=None) -> Union[Any | None]:  # noqa: N802  # pragma: no cover
        return self.GetAllSdrMetadata().get(key, default_value)

    def GetRenderType(self) -> Union[str | None]:  # noqa: N802  # pragma: no cover
        return self.GetMetadata(Sdr.PropertyMetadata.RenderType)

    def GetMdlStructType(self) -> Union[str | None]:  # noqa: N802  # pragma: no cover
        return self.GetSdrMetadata(omni.UsdMdl.Metadata.StructType)

    def GetMdlSymbol(self) -> Union[str | None]:  # noqa: N802  # pragma: no cover
        return self.GetSdrMetadata(omni.UsdMdl.Metadata.Symbol)

    def GetMdlArrayElementType(self) -> Union[str | None]:  # noqa: N802  # pragma: no cover
    ...
    def GetDocumentation(self) -> Union[str | None]:  # noqa: N802  # pragma: no cover
        return self.GetMetadata("documentation")

    def GetConnectability(self) -> Union[str | None]:  # noqa: N802  # pragma: no cover
