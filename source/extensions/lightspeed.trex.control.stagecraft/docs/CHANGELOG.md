...
## [1.5.5]
## Fixed
- Fixed tests for new vertical tabs layout
...
## [1.5.2]
## Fixed
- Tests: Removed exclusion for stdout pattern that should not be triggered anymore
