...
## [2.0.1]
### Added
- Added the global viewport selection deletion request event name.
...
## [1.12.0]
### Added
- Added OmniGraph constants for remix logic support
...
## [1.10.1]
### Added
- Added constants for ComfyUI window name
