...
from .workspace import SideBarWindow as _SideBarWindow


class TrexSideBarWindowExtension(omni.ext.IExt):
    """SideBar Window Extension"""

    def on_startup(self, ext_id):
        carb.log_info("[lightspeed.trex.sidebar] Startup")
        self._workspace_window = _SideBarWindow(_TrexContexts.STAGE_CRAFT.value, show_dock_tab_bars=False)
    ...
    def on_shutdown(self):
        carb.log_info("[lightspeed.trex.sidebar] Shutdown")
