...
## [1.4.0]
### Added
- `Spotlight Cones` toggle under the Lights section, backed by `/persistent/app/viewport/manipulator/spotlightConeVisible` (visualization implemented in `lightspeed.ui_scene.light_manipulator`)
