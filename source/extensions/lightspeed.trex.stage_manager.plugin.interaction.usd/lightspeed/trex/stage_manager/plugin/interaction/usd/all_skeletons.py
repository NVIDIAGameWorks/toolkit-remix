...
__all__ = ["RemixAllSkeletonsInteractionPlugin"]

from omni.flux.stage_manager.plugin.interaction.usd import AllSkeletonsInteractionPlugin
from pydantic import Field

from .base import RemixStageManagerUSDInteractionPlugin


class RemixAllSkeletonsInteractionPlugin(AllSkeletonsInteractionPlugin, RemixStageManagerUSDInteractionPlugin):
    """
    ...
    compatible_widgets: list[str] = Field(
        default=[
            *AllSkeletonsInteractionPlugin.model_fields["compatible_widgets"].default,
            # Remix widgets
