...
__all__ = ["RemixAllPrimsInteractionPlugin"]

from omni.flux.stage_manager.plugin.interaction.usd import AllPrimsInteractionPlugin
from pydantic import Field

from .base import RemixStageManagerUSDInteractionPlugin


class RemixAllPrimsInteractionPlugin(AllPrimsInteractionPlugin, RemixStageManagerUSDInteractionPlugin):
    """
    ...
    compatible_filters: list[str] = Field(
        default=[
            *AllPrimsInteractionPlugin.model_fields["compatible_filters"].default,
            # Remix filters
    ...
    compatible_widgets: list[str] = Field(
        default=[
            *AllPrimsInteractionPlugin.model_fields["compatible_widgets"].default,
            # Remix widgets
