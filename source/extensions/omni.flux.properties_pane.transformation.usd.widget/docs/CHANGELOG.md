...
## [2.10.0]
### Fixed
- Passed related xform property paths into transform rows so xform overrides are authored as one logical set.

## [2.9.0]
### Added
- Added optional layer-transfer callback forwarding for transform property menus.
