...
__all__ = ["TrexComfyUIWindowExtension"]
...
from .workspace import ComfyUIWindow


class TrexComfyUIWindowExtension(omni.ext.IExt):
    """ComfyUI Window Extension"""

    def on_startup(self, ext_id):
        carb.log_info("[lightspeed.trex.comfyui.widget] Startup")
        self._workspace_window = ComfyUIWindow(Contexts.STAGE_CRAFT.value)
        self._workspace_window.create_window(width=350, height=300)
