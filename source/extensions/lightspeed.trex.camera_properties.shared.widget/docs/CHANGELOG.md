...
- Restored direct dependencies required by the camera property pane during isolated startup.

## [1.2.1]
### Fixed
- Redirected game-camera property editing to the perspective camera copy to keep capture cameras read-only
