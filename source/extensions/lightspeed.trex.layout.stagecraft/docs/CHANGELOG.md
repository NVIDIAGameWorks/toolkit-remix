...
## [2.5.3]
## Changed
- Changed modding tabs to vertical layout consistent with ingestion and AI Tools tabs
...
## [2.4.2]
## Changed
- Removed unneeded Stage Manager refresh callback
...
### Fixed
- Fixed crash with recent saved files thumbnails function
