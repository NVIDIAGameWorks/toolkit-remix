...
from .setup_ui import AssetReplacementsPane as _AssetReplacementsPane


class PropertiesWindow(_WorkspaceWindowBase):
    """Global "Properties" pane window manager"""

    @property
    def title(self) -> str:
        return _WindowNames.PROPERTIES
    ...
    def _create_window_ui(self):
        return _AssetReplacementsPane(self._usd_context_name)
