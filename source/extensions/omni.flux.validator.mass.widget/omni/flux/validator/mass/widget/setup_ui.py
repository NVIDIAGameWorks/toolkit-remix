                        ...
                        with ui.VStack():
                            ...
                            with ui.HStack(height=ui.Pixel(24)):
                                ...
                                with ui.HStack(width=ui.Percent(50), spacing=ui.Pixel(8)):
                                    ui.Spacer()
                                    ui.Label("Executor:", width=0)
                                    self._executors_cb = ui.ComboBox(
                                        1,
                                        *[executor.name.replace("_", " ").capitalize() for executor in _MassExecutors],
                                    )
                                    with ui.VStack(width=0):
                                        ...
                                        self._normals_type_info_icon = _InfoIconWidget(
                                            message=(
                                                ...
                                                "Options:\n"
                                                "- Process executor: will run the ingestion in an external process "
                                                "(recommended)\n"
                                                "- Async executor: will run the ingestion asynchronously on the main "
                                                "thread"
                                            )
                                        )
                                        ui.Spacer()
