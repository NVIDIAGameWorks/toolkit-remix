...
class TestIntDragFieldUnit(omni.kit.test.AsyncTestCase):
    """Unit tests for IntDragField logic (no UI rendering)."""
    ...
    async def test_default_constructor_values(self):
        """IntDragField defaults: min=None, max=None, step=None, style='DragField'."""
        field = IntDragField()
    ...
    async def test_default_step_very_large_range(self):
        ...
        field = IntDragField(min_value=0, max_value=10000)
    ...
    async def test_default_step_boundary_101(self):
        ...
        field = IntDragField(min_value=0, max_value=101)
        self.assertEqual(field.step, 1)

    async def test_default_step_boundary_200(self):
        """Range of 200 should yield step 2."""
        field = IntDragField(min_value=0, max_value=200)
    ...
    async def test_custom_step_overrides_default(self):
        ...
        field = IntDragField(min_value=0, max_value=100, step=10)
        self.assertEqual(field.step, 10)
