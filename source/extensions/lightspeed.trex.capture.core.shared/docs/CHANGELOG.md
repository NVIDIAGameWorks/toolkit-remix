...
## [1.4.3]
### Changed
- Classify capture files from metadata-only anonymous layers, reject USD open errors, and provide bounded discovery
  with thumbnail pairing for valid captures.
