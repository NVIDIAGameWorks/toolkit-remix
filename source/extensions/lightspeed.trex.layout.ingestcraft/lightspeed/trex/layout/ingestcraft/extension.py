...
class TrexIngestCraftLayoutExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        ...
        trex_contexts_instance().create_usd_context(TrexContexts.INGEST_CRAFT)
    ...
    def on_shutdown(self):
        global _SETUP_INSTANCE
        carb.log_info("[lightspeed.trex.layout.ingestcraft] Shutdown")
        if _SETUP_INSTANCE:
