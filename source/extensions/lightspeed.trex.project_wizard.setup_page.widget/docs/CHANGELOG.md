...
## [1.3.2]
### Changed
- Delegate bounded capture discovery and thumbnail resolution to Capture Core, and invoke the current primary wizard
  action when a valid capture is double-clicked on an unblocked page.
