...
from .workspace import CaptureWindow as _CaptureWindow


class TrexCaptureWindowExtension(omni.ext.IExt):
    """Capture Window Extension"""

    def on_startup(self, ext_id):
        carb.log_info("[lightspeed.trex.capture_tree.widget] Startup")
        self._workspace_window = _CaptureWindow(_TrexContexts.STAGE_CRAFT.value)
    ...
    def on_shutdown(self):
        carb.log_info("[lightspeed.trex.capture_tree.widget] Shutdown")
