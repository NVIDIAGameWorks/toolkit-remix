...
class UsdSelectionHistoryUSDWidgetExtension(omni.ext.IExt):
    """Create Final Configuration"""

    def on_startup(self, ext_id):
        global _USD_LISTENER_INSTANCE
        carb.log_info("[omni.flux.selection_history_tree.model.usd] Startup")
        _USD_LISTENER_INSTANCE = _USDListener()

    def on_shutdown(self):
        global _USD_LISTENER_INSTANCE
        carb.log_info("[omni.flux.selection_history_tree.model.usd] Shutdown")
