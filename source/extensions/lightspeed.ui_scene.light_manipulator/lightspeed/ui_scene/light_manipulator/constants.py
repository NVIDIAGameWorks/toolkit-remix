...
CONE_SIDES_DEFAULT = 32
CONE_SIDES_MIN_INPUT = 6
CONE_SIDES_MAX_INPUT = 128
CONE_OUTER_COLOR_DEFAULT = (0.0, 1.0, 0.0)  # green
CONE_INNER_COLOR_DEFAULT = (0.0, 1.0, 1.0)  # cyan
CONE_THRESHOLD_DEFAULT = 0.1  # lux
CONE_THRESHOLD_MIN_INPUT = 0.001  # UI input floor
CONE_THRESHOLD_MIN = 1e-6  # divide-by-zero floor
CONE_LENGTH_MIN = 0.01  # meters
CONE_LENGTH_MAX = 1000.0  # meters
SPOTLIGHT_CONE_ANGLE_MAX = 90.0
