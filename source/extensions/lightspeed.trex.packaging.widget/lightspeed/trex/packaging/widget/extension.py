...
from .workspace import PackagingWindow as _PackagingWindow


class TrexPackagingWindowExtension(omni.ext.IExt):
    """Mod Packaging Window Extension"""

    def on_startup(self, ext_id):
        carb.log_info("[lightspeed.trex.packaging.widget] Startup")
        self._workspace_window = _PackagingWindow(_TrexContexts.STAGE_CRAFT.value)
    ...
    def on_shutdown(self):
        carb.log_info("[lightspeed.trex.packaging.widget] Shutdown")
