...
class TestPackagingPaneVisibilityFiltering(AsyncTestCase):
    """
    Test that @skip_when_widget_is_invisible decorator works on PackagingPane's decorated methods.
    """
    ...
    async def test_decorated_methods_skip_when_invisible(self):  # noqa: PLW0212
        ...
        # Arrange
        window = ui.Window("test_packaging", width=600, height=800)
        with window.frame:
        ...
        await omni.kit.app.get_app().next_update_async()
        self.assertNotEqual(widget._on_packaging_progress(50, 100, "Processing..."), SKIPPED)  # noqa: PLW0212

        # Act & Assert: When invisible
        widget.root_widget.visible = False
        await omni.kit.app.get_app().next_update_async()
        self.assertEqual(widget._on_packaging_progress(75, 100, "Almost done..."), SKIPPED)  # noqa: PLW0212
    ...
    async def test_skips_when_parent_frame_invisible(self):  # noqa: PLW0212
        ...
        widget.root_widget.visible = True
        self.assertNotEqual(widget._on_packaging_progress(10, 100, "Starting..."), SKIPPED)  # noqa: PLW0212

        # Act & Assert: When parent invisible
        parent_frame.visible = False
        await omni.kit.app.get_app().next_update_async()
        self.assertEqual(widget._on_packaging_progress(20, 100, "Continuing..."), SKIPPED)  # noqa: PLW0212
    ...
    async def test_skips_when_window_invisible(self):  # noqa: PLW0212
        ...
        widget.root_widget.visible = True
        self.assertNotEqual(widget._on_packaging_progress(30, 100, "Working..."), SKIPPED)  # noqa: PLW0212

        # Act & Assert: When window invisible
        window.visible = False
        await omni.kit.app.get_app().next_update_async()
        self.assertEqual(widget._on_packaging_progress(40, 100, "Still working..."), SKIPPED)  # noqa: PLW0212
